                ...
                <Grid container spacing={3} justifyContent="center">
                  ...
                  <Grid item xs={12} sm={6}>
                    ...
                    <TextField
                      ...
                      onChange={(e) => setmaterialData({ ...materialData, detail: e.target.value })}
                    />
                    <TextField
                      required
                      fullWidth
                    ...
                    <TextField
                      ...
                      onChange={(e) => setmaterialData({ ...materialData, floor_id: e.target.value })}
                      select
                      >
                  ...
                  <Grid item xs={12} sm={4} className="mt-5">
                    ...
                    <Grid container justifyContent="center" alignItems="center" className="mt-5 mb-5 flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 rounded-lg bg-gray-50">
                        <img src={materialData.image_url} alt="Uploaded Image" className="max-h-48 max-w-full" />
                    </Grid>
